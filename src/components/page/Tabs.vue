  ...
  <span slot="footer" class="dialog-footer">
        ...
        <div class="container">
            <div class="handle-box" style="display:flex">
                ...
                <el-select v-model="query.stuClasse" placeholder="班级" disabled class="handle-select mr10">
                    <el-option
                ...
                <el-input style="width:20%;margin-right:5%" v-model="query.name" disabled placeholder="请输入学号"></el-input>
...
export default {
    ...
    data() {
        return {
            ...
            query: {
                stuGrade: localStorage.getItem('stuGrade'),
                name: localStorage.getItem('stuId'),
                stuClasse:localStorage.getItem('class').slice(0,2),
                studate:''
            },
